...
table_data <- read_excel_allsheets("D:/OneDrive/Documents/GitHub/CNAIM/data-raw/excel-spreadsheets/table_data.xlsx", tibble=T)
table_index <- read_excel_allsheets("D:/OneDrive/Documents/GitHub/CNAIM/data-raw/excel-spreadsheets/table_index.xlsx", tibble=T)
...
example_risk_matrix <- readRDS('D:/OneDrive/Documents/GitHub/CNAIM/data-raw/matrix_data_structure.rds')

#save(gb_ref, example_risk_matrix, file = "R/sysdata.rda")
save(gb_ref, example_risk_matrix, file = "D:/OneDrive/Documents/GitHub/CNAIM/R/sysdata.rda")
